...
import kloppy.infra.serializers.event.impect.specification as SB
from kloppy import impect, impect
...
def dataset(base_dir) -> EventDataset:
    """Load Impect data for Belgium - Portugal at Euro 2020"""
    dataset = impect.load(
        event_data=base_dir / "files" / "impect_events.json",
        lineup_data=base_dir / "files" / "impect_meta.json",
    )
...
#
#             plt.savefig(
#                 base_dir / "outputs" / "test_impect_freeze_frame_shot.png"
#             )
#
...
#
#             plt.savefig(
#                 base_dir / "outputs" / "test_impect_freeze_frame_360.png"
#             )
#
...
#
#         The Impect "Own Goal For" (id = 25) and one "Own Goal Against" (id = 20) events
#         should be converted to a single shot event with ShotResult.OWN_GOAL.
#         """
#         dataset = impect.load(
#             lineup_data=base_dir / "files" / "impect_lineup.json",
#             event_data=base_dir / "files" / "impect_event.json",
#         )
#
...
#
#
# class TestImpectMiscontrolEvent:
...
#
#
# class TestsImpectBadBehaviourEvent:
...
#
#
# class TestImpectPlayerOffEvent:
...
#
#
# class TestImpectTacticalShiftEvent:
