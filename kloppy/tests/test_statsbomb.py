...
class TestStatsBombPassEvent:
    ...
    def test_open_play(self, dataset: EventDataset):
        ...
        assert pass_event.receive_timestamp == parse_str_ts("00:35:21.533") + timedelta(
            seconds=0.634066
        )
    ...
    def test_set_piece(self, dataset: EventDataset):
        ...
        pass_event = dataset.get_event_by_id("8022c113-e349-4b0b-b4a7-a3bb662535f8")
        assert (
            pass_event.get_qualifier_value(SetPieceQualifier) == SetPieceType.KICK_OFF
        )
...
class TestStatsBombShotEvent:
    ...
    def test_open_play(self, dataset: EventDataset):
        ...
        assert (
            next(
                statistic for statistic in shot.statistics if statistic.name == "xG"
            ).value
            == 0.12441643
        )
...
class TestStatsBombFoulCommittedEvent:
    ...
    def test_card(self, dataset: EventDataset):
        ...
        assert (
            foul_with_card.get_qualifier_value(CardQualifier) == CardType.FIRST_YELLOW
        )
