...
class TestStatsperformTracking:
    ...
    def meta_data(self) -> str:
        ...
        return f"{base_dir}/files/statsperform_temp_match_tracking_7ijuqohwgmplbxdj1625sxwfe.xml"

    @pytest.fixture
    def raw_data(self) -> str:
        base_dir = os.path.dirname(__file__)
        return f"{base_dir}/files/statsperform_SOCCER_GAME_OPT_10FPS$2456693.txt"

    @pytest.fixture
    def player_data(self) -> str:
        base_dir = os.path.dirname(__file__)
        return f"{base_dir}/files/statsperform_SOCCER_PLAYERS_OPT$2456693.csv"
